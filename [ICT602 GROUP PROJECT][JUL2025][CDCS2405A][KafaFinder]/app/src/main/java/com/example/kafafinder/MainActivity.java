...
public class MainActivity extends AppCompatActivity {
    ...
    LinearLayout btnOpenMap, btnFeedback, btnDeveloper;
    FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // OnClick: Go to MapsActivity
        btnOpenMap.setOnClickListener(view -> {
            Intent intent = new Intent(MainActivity.this, MapsActivity.class);
            startActivity(intent);
        });

        // OnClick: (Optional) go to Feedback activity
        btnFeedback.setOnClickListener(view -> {
            // Replace with your actual FeedbackActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_home) {
            ...
            Intent aboutIntent = new Intent(MainActivity.this, UserProfileActivity.class);
            startActivity(aboutIntent);
            return true;
